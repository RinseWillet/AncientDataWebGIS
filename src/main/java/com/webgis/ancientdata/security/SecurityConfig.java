    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) {
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/raster/catalog/admin").hasRole(ADMIN)
                        .requestMatchers(HttpMethod.POST, "/api/raster/catalog").hasRole(ADMIN)
                        .requestMatchers(HttpMethod.PATCH, "/api/raster/catalog/**").hasRole(ADMIN)
                        .requestMatchers(HttpMethod.DELETE, "/api/raster/catalog/**").hasRole(ADMIN)
