...
VALUES (100001, 'Castellum Nigrum Pullum (dev seed)', ST_SetSRID(ST_MakePoint(4.9410, 52.0530), 4326),
       ...
       (100003, 'Sample Possible Villa (dev seed)', ST_SetSRID(ST_MakePoint(5.2020, 51.0980), 4326), 'Germania Inferior',
        'pvilla', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100005, 'Sample Possible Settlement A (dev seed)', ST_SetSRID(ST_MakePoint(5.0500, 51.9200), 4326), 'Germania Inferior',
        'psett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100006, 'Sample Possible Settlement B (dev seed)', ST_SetSRID(ST_MakePoint(5.6500, 51.8600), 4326), 'Germania Inferior',
        'psett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100007, 'Sample Bridge (dev seed)', ST_SetSRID(ST_MakePoint(5.3500, 52.1500), 4326), 'Germania Inferior',
        'bridge', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100008, 'Sample Historically Attested Settlement A (dev seed)', ST_SetSRID(ST_MakePoint(5.4800, 52.0200), 4326), 'Germania Inferior',
        'histSett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100009, 'Sample Historically Attested Settlement B (dev seed)', ST_SetSRID(ST_MakePoint(4.8700, 51.8300), 4326), 'Germania Inferior',
        'histSett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100010, 'Sample Historically Attested Settlement C (dev seed)', ST_SetSRID(ST_MakePoint(5.9200, 52.1900), 4326), 'Germania Inferior',
        'histSett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100011, 'Sample Historically Attested Settlement D (dev seed)', ST_SetSRID(ST_MakePoint(5.1600, 51.7200), 4326), 'Germania Inferior',
        'histSett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100012, 'Sample Settlement A (dev seed)', ST_SetSRID(ST_MakePoint(5.2500, 51.9500), 4326), 'Germania Inferior',
        'sett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100013, 'Sample Settlement B (dev seed)', ST_SetSRID(ST_MakePoint(5.3200, 51.9800), 4326), 'Germania Inferior',
        'sett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100014, 'Sample Settlement With Stone Buildings A (dev seed)', ST_SetSRID(ST_MakePoint(5.4000, 52.0100), 4326), 'Germania Inferior',
        'settS', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100015, 'Sample Settlement With Stone Buildings B (dev seed)', ST_SetSRID(ST_MakePoint(5.4700, 52.0400), 4326), 'Germania Inferior',
        'settS', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       -- Tight cluster (dev seed): 6 sites within ~150m of each other, mixed
       -- types, for testing click-precision on overlapping markers.
       (100016, 'Cluster Site A - Castellum (dev seed)', ST_SetSRID(ST_MakePoint(5.6640, 52.0410), 4326), 'Germania Inferior',
        'castellum', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100017, 'Cluster Site B - Settlement (dev seed)', ST_SetSRID(ST_MakePoint(5.6648, 52.0413), 4326), 'Germania Inferior',
        'sett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100018, 'Cluster Site C - Possible Settlement (dev seed)', ST_SetSRID(ST_MakePoint(5.6635, 52.0406), 4326), 'Germania Inferior',
        'psett', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100019, 'Cluster Site D - Cemetery (dev seed)', ST_SetSRID(ST_MakePoint(5.6644, 52.0403), 4326), 'Germania Inferior',
        'cem', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
       (100020, 'Cluster Site E - Villa (dev seed)', ST_SetSRID(ST_MakePoint(5.6652, 52.0408), 4326), 'Germania Inferior',
        'villa', NULL, NULL,
        'Synthetic local-dev seed site — not real archaeological data.'),
...
VALUES ('Sheet A1', 'ancientdata:De-Man-1818-A1', 51.782659965003994, 5.757907509752199, 51.87017277720497,
       ...
       ('DEM of Gelderland-NRW research area - Hillshade', 'ancientdata:research_area_Gelderland_NRW_hillshade_cog',
        ...
        'AHN3 (NL) & DGM1 (NRW, DE) LiDAR', 'DEM', 'Gelderland-NRW', TRUE),
       ('DEM of Gelderland-NRW research area', 'ancientdata:research_area_Gelderland_NRW_cog', 51.45783572791835,
        5.419587299877188, 52.0690994943719, 6.865869726173805, 8, 17, 'AHN3 (NL) & DGM1 (NRW, DE) LiDAR', 'DEM',
        'Gelderland-NRW', FALSE),
       ('DEM of Swalmen area (AHN3 + DGM1) - Hillshade', 'ancientdata:merge_swalmen_hillshade_cog', 51.14425175970463,
        5.965415083893099, 51.35358917449149, 6.409873937995263, 8, 17, 'AHN3 & DGM1 LiDAR', 'DEM', 'Swalmen', TRUE),
       ('DEM of Swalmen area (AHN3 + DGM1)', 'ancientdata:merge_swalmen_cog', 51.14425175970463, 5.965415083893099,
        51.35358917449149, 6.409873937995263, 8, 17, 'AHN3 & DGM1 LiDAR', 'DEM', 'Swalmen', FALSE),
       ...
       ('DEM of Geldern - Venlo area (DGM1, AHN3)', 'ancientdata:merge_venlo_geldern_cog', 51.3350043816511,
        5.966035132096261, 51.54046275728694, 6.416339886112167, 8, 18, 'AHN3 & DGM1 LiDAR', 'DEM', 'Geldern - Venlo',
        FALSE),
       ('DEM of Mönchengladbach - Neuss area (DGM1) - Hillshade', 'ancientdata:dem_Mönchengladbach-Neuss-hillshade',
        51.09919903622249, 6.423118334166201, 51.21238621797372, 6.685970391067374, 8, 17, 'DGM1 LiDAR', 'DEM',
        'Mönchengladbach - Neuss', TRUE),
       ('DEM of Mönchengladbach - Neuss area (DGM1)', 'ancientdata:Mönchengladbach-Neuss-merge_cog', 51.09919903622249,
        6.423118334166201, 51.21238621797372, 6.685970391067374, 8, 17, 'DGM1 LiDAR', 'DEM', 'Mönchengladbach - Neuss',
        FALSE),
       ('DEM of area west of Mönchengladbach (DGM1, AHN3) - Hillshade', 'ancientdata:Mönchengladbach_west-hillshade',
        ...
        'Area west of Mönchengladbach', TRUE),
       ('DEM of area west of Mönchengladbach (DGM1, AHN3)', 'ancientdata:Mönchengladbach_west-merge_cog',
        51.02210046622095, 6.192158255124815, 51.24292939309103, 6.433099522466674, 8, 17, 'AHN3 & DGM1 LiDAR', 'DEM',
        'Area west of Mönchengladbach', FALSE) ON CONFLICT DO NOTHING;
